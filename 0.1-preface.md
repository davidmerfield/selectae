...
*Je ne me gêne pas non plus par une exactitude scrupuleuse, à mettre dans tous les Chapitres un certain nombre d'examples & une certaine mesure de morale.*
I do not bother myself with a scrupulous exactness, to place in all the chapters a certain number of examples and a certain measure of morals.

*J'en mets tantôt plus tantôt moins.*
I sometimes placed there more and sometimes less.

*Il y a même des Chapitres qui ne contiennent que des [Page 9] examples, ou de la morale seulement.*
There are even some chapters which only contain examples, or only morals.

*Je suis persuadé que l'uniformité, que peut-être quelques personnes desireroient, ne plairoit point aux enfants.*
I am convinced that uniformity, which perhaps some people desire, would not please children.

¶

*Comme il ya une espèce d'enchainement entre toutes les vertus, & que souvent une belle action, selon qu'on la considérera sous différentes faces, pourra être regardée comme un acte de prudence, par exemple, ou comme un acte de justice, j'ai mis quelquefois sous un titre ce qui auroit pu être mis également sous un autre.*
As there is a relation between all the virtues, and that often one good action, when one considers it from a different aspect, could be seen as an act of prudence, for example, or as an act of justice, I sometimes put under one title that which could equally be put under another.

Il feroit inutile de dire ce qui ma déterminé en ces occasions pourvu que ce qu'on trouve dans un Recueil comme celui-ci, ait foa utilité, de quelle conféquence eft-il quil soit placé dans un endroit plutôt que dans
un autre?

Je me fuis fervi de tous les anciens Au
teurs profanes tant Grecs que Latiıns, que
ai cru pouvoir contribuer à l'exécution de
mon defein. 

Je les ai même quelquefois pour ainlf dire , fondus enfemble fur un
même fait ou fur une meme mazime, pour mieux faire fentir l'objet que je montrois
8 éviter le redites.

J'ai ordinairement préferé, comme je le devois , les Latins aux
Grecs. 

Jai été exact à citer les uns & les autres ain que les perlonnes qui vcu
