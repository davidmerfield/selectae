...
Comme il ya une espèce d'enchainement entre toutes les vertus, & que souvent une
belle action, selon qu'on la considérera sous différentes faces, pourra etre regardée comme un ačte de prudence, par exemple, ou comme un acte de justice, Jai mis qual quetois sous un titre ce qui auroit pu être mis également sous un autre.
